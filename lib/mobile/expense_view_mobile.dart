...
class ExpenseViewMobile extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    //Check if the stream is loading, and if so, do not display.
    if(isLoading){
                  ...
                  child: Row(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          Poppins(text: "Budget left", size: 40.0, color: Colors.white,),
                          Poppins(text: "Total Expense", size: 40.0, color: Colors.white,),
                          Poppins(text: "Total Income", size: 40.0, color: Colors.white,),
                        ],
                      ),
                      RotatedBox(
                        quarterTurns: 1,
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      OpenSans(text: "Expenses", size: 40.0),
                      Container(
                  ...
                  Column(
                    ...
                    children: [
                      OpenSans(text: "Incomes", size: 40.0),
                      Container(
                        padding: EdgeInsets.all(7.0),
                        height: 210.0,
                        width: 180.0,
